...
namespace FishBusiness.Data.Migrations
{
    ...
    [Migration("20200904190703_AdditionalPayment_Collecting")]
    partial class AdditionalPayment_Collecting
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FishBusiness.Models.AdditionalPayment", b =>
                {
                    ...
                    b.Property<int?>("AdditionalPaymentID1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdditionalPaymentID1");
            ...
            modelBuilder.Entity("FishBusiness.Models.AdditionalPayment", b =>
                {
                    b.HasOne("FishBusiness.Models.AdditionalPayment", null)
                        .WithMany("AdditionalPayments")
                        .HasForeignKey("AdditionalPaymentID1");
                });
            ...
            modelBuilder.Entity("FishBusiness.Models.Collecting", b =>
                {
                    b.HasOne("FishBusiness.Models.AdditionalPayment", "AdditionalPayment")
                        .WithMany()
                        .HasForeignKey("AdditionalPaymentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
